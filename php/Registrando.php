...
<body>
<div align="center">
<a href="index.php"><img width="400px" height="200" src="img/icono.ico" alt="logo de la pagina"></a>

<?php
 if ($count == 1  ) {

 header("location: crearCuenta.php?variable1=El Nombre de Usuario ya esta en uso");
 
 }
 else if($count2 == 1){
 header("location: crearCuenta.php?variable2=El correo ya esta en uso ");
  } else if($count3 == 1){
 header("location: crearCuenta.php?variable3=la cedula ya esta en uso ");
  }
